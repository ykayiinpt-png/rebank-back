...
RESET_PASSWORD_EXP_MINUTES = int(os.environ.get('RESET_PASSWORD_EXP_MINUTES', 5))
LOGIN_SESSION_EXPIRE_MINUTES = int(os.environ.get('LOGIN_SESSION_EXPIRE_MINUTES', 30))

# OTP
OTP_LENGTH = int(os.environ.get('OTP_LENGTH', 6))
OTP_EXP_DURATION_MINUTES = int(os.environ.get('OTP_EXP_DURATION_MINUTES', 6))

# Registration
REGISTRATION_RESEND_COOLDOWN_MINUTES = int(os.environ.get('REGISTRATION_RESEND_COOLDOWN_MINUTES', 5))
